  ...
  return (
    <Markdown
      components={{
        ...
        h1: ({ children }) => (
          <h1 className="text-lg font-light mb-2">{children}</h1>
        ),
        h2: ({ children }) => (
          <h2 className="text-base font-light mb-2">{children}</h2>
        ),
        h3: ({ children }) => (
        ...
        pre: ({ children }) => (
          <pre className="p-3 bg-muted overflow-x-auto mb-2 text-xs">
            {children}
          </pre>
        ),
        strong: ({ children }) => (
