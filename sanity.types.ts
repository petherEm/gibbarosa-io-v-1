...
export type Product = {
  ...
  material?: "leather" | "metal" | "gold" | "rose-gold" | "white-gold" | "silver" | "platinum" | "fabric" | "silk" | "wool" | "cashmere" | "cotton" | "canvas" | "coated-canvas" | "nylon" | "wood" | "glass" | "acetate" | "optyl" | "titanium" | "diamond";
  color?: "black" | "white" | "grey" | "cream" | "beige" | "brown" | "caramel" | "cognac" | "latte" | "gold" | "silver" | "rose-gold" | "red" | "burgundy" | "pink" | "plum" | "orange" | "yellow" | "green" | "blue" | "navy" | "purple" | "transparent" | "multicolor";
  dimensions?: string;
...
// Query: *[  _type == "category"] | order(title asc) {  _id,  title,  "slug": slug.current,  "image": image{    asset->{      _id,      url    },    hotspot  },  "productCount": count(*[_type == "product" && references(^._id)])}
export type CATEGORIES_WITH_COUNT_QUERYResult = Array<{
  _id: string;
  title: string | null;
  slug: string | null;
  image: {
...
export type ALL_PRODUCTS_QUERYResult = Array<{
  ...
  material: "acetate" | "canvas" | "cashmere" | "coated-canvas" | "cotton" | "diamond" | "fabric" | "glass" | "gold" | "leather" | "metal" | "nylon" | "optyl" | "platinum" | "rose-gold" | "silk" | "silver" | "titanium" | "white-gold" | "wood" | "wool" | null;
  color: "beige" | "black" | "blue" | "brown" | "burgundy" | "caramel" | "cognac" | "cream" | "gold" | "green" | "grey" | "latte" | "multicolor" | "navy" | "orange" | "pink" | "plum" | "purple" | "red" | "rose-gold" | "silver" | "transparent" | "white" | "yellow" | null;
...
// Query: *[  _type == "product"  && featured == true  && stock > 0] | order(name asc) [0...6] {  _id,  name,  "slug": slug.current,  description,  price,  brand,  condition,  "images": images[]{    _key,    asset->{      _id,      url    },    hotspot  },  category->{    _id,    title,    "slug": slug.current  },  stock}
export type FEATURED_PRODUCTS_QUERYResult = Array<{
  ...
  price: number | null;
  brand: string | null;
  condition: "excellent" | "good" | "like-new" | "new" | "very-good" | null;
  images: Array<{
    _key: string;
    asset: {
      _id: string;
...
// Variable: HERO_PRODUCTS_QUERY
// Query: *[  _type == "heroSettings"][0] {  "products": featuredProducts[]->{    _id,    name,    "slug": slug.current,    price,    brand,    "image": images[0]{      asset->{        _id,        url      }    }  }}
export type HERO_PRODUCTS_QUERYResult = null;
...
// Query: *[  _type == "product"  && slug.current == $slug][0] {  _id,  name,  "slug": slug.current,  brand,  description,  price,  compareAtPrice,  "images": images[]{    _key,    asset->{      _id,      url,      metadata {        dimensions {          width,          height        }      }    },    hotspot  },  category->{    _id,    title,    "slug": slug.current  },  material,  color,  dimensions,  condition,  conditionDetails,  productionYear,  serialNumber,  accessories,  stock,  featured}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($condition == "" || condition == $condition)  && ($color == "" || color == $color)  && ($material == "" || material == $material)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*" || brand match $searchQuery + "*")  && ($inStock == false || stock > 0)  && ($onSale == false || (defined(compareAtPrice) && compareAtPrice > price))] | order(name asc) {  _id,  name,  "slug": slug.current,  brand,  price,  compareAtPrice,  condition,  releaseDate,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  material,  color,  stock}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($condition == "" || condition == $condition)  && ($color == "" || color == $color)  && ($material == "" || material == $material)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*" || brand match $searchQuery + "*")  && ($inStock == false || stock > 0)  && ($onSale == false || (defined(compareAtPrice) && compareAtPrice > price))] | order(price asc) {  _id,  name,  "slug": slug.current,  brand,  price,  compareAtPrice,  condition,  releaseDate,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  material,  color,  stock}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($condition == "" || condition == $condition)  && ($color == "" || color == $color)  && ($material == "" || material == $material)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*" || brand match $searchQuery + "*")  && ($inStock == false || stock > 0)  && ($onSale == false || (defined(compareAtPrice) && compareAtPrice > price))] | order(price desc) {  _id,  name,  "slug": slug.current,  brand,  price,  compareAtPrice,  condition,  releaseDate,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  material,  color,  stock}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($condition == "" || condition == $condition)  && ($color == "" || color == $color)  && ($material == "" || material == $material)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*" || brand match $searchQuery + "*")  && ($inStock == false || stock > 0)  && ($onSale == false || (defined(compareAtPrice) && compareAtPrice > price))] | score(  boost(name match $searchQuery + "*", 3),  boost(brand match $searchQuery + "*", 3),  boost(description match $searchQuery + "*", 1)) | order(_score desc, name asc) {  _id,  name,  "slug": slug.current,  brand,  price,  compareAtPrice,  condition,  releaseDate,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  material,  color,  stock}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($condition == "" || condition == $condition)  && ($color == "" || color == $color)  && ($material == "" || material == $material)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*" || brand match $searchQuery + "*")  && ($inStock == false || stock > 0)  && ($onSale == false || (defined(compareAtPrice) && compareAtPrice > price))] | order(coalesce(releaseDate, _createdAt) desc) {  _id,  name,  "slug": slug.current,  brand,  price,  compareAtPrice,  condition,  releaseDate,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  material,  color,  stock}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[\n  _type == \"category\"\n] | order(title asc) {\n  _id,\n  title,\n  \"slug\": slug.current,\n  \"image\": image{\n    asset->{\n      _id,\n      url\n    },\n    hotspot\n  },\n  \"productCount\": count(*[_type == \"product\" && references(^._id)])\n}": CATEGORIES_WITH_COUNT_QUERYResult;
